...
loadEditorWithViewport::loadEditorWithViewport(AudioProcessorEditor* allEditor) : Component()
{
...
Viewport* loadEditorWithViewport::getEditor() {
    MessageManager::getInstance()->callAsync ([=]
    {
        //printf("test\r\n");
    #if JUCE_IOS
        myEditor->setVisible (true); //george change this back to false
    #else
        ...
        //itemHolder.addAndMakeVisible(myEditor); //start by commenting this out
